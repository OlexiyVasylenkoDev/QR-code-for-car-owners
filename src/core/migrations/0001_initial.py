...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='QRCode',
            fields=[
                ('hash', models.CharField(max_length=256, primary_key=True, serialize=False, unique=True, verbose_name='hash')),
                ('password', models.CharField(max_length=128, verbose_name='password')),
                ('is_active', models.BooleanField(default=False, verbose_name='active')),
                ('message', models.CharField(blank=True, default=None, max_length=140, null=True, verbose_name='message')),
